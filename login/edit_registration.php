...
if(isset($_POST['submit'])){
  ...
  $sql2 = "update registeration set fname = '$fname' ,lname = '$lname' ,image= '$img', email = '$email', pass = '$pass', 
  contact = '$contact', gender = '$gender' , state = '$state',profile = '$profile' , hobies = '$hobies' 
  where id='$id'";
...
<button class = "btn btn-warning btn-lg" name = "submit">Update</button>
</div>
